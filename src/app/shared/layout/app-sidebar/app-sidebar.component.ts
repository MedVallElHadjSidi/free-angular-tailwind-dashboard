...
export class AppSidebarComponent {
  ...
  navItems: NavItem[] = [
    ...
    // },
    {
      ...
      subItems: [
        { name: "Création d'expression ", path: "/form-elements", pro: false }
      ],
    },
    {
      ...
      subItems: [
        { name: "Liste des bons de commandes", path: "/basic-tables", pro: false },
      ],
    },
    {
      name: "Référentiel",
      ...
      subItems: [
        { name: "Structure", path: "/blank", pro: false },
        { name: "Bénéficiaire", path: "/error-404", pro: false },
      ],
    },
  ];
  // Others nav items
